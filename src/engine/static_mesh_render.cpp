...
void StaticMeshComponent::GetDynamicMeshElements(const std::vector<const SceneView *> &Views, const ViewFamily &ViewFamily, uint32 VisibilityMap, MeshElementCollector &Collector) const
{
    assert(0);
}
